...
parser.add_argument("--log-every", type=int, default=10, help="log training metrics to wandb every N steps")
# Runtime
...
# Model architecture
parser.add_argument("--mamba", action="store_true", help="use the Mamba backbone instead of GPT")
